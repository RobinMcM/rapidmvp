    ...
    <div className="bg-rm-black min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 flex flex-col gap-8">
          ...
          {/* Security & Compliance */}
          <section>
            <h2 className="text-white font-semibold text-lg mb-4">Security Posture</h2>
          ...
          <section>
            <h2 className="text-white font-semibold text-lg mb-4">Indicative Cost Drivers</h2>
            <div className="rounded-xl bg-rm-dark-2/70 border border-slate-800 p-5">
          ...
          {/* Risk areas */}
          <section>
            <h2 className="text-white font-semibold text-lg mb-4">Risk Areas to Review</h2>
            <div className="rounded-xl bg-rm-dark-2/70 border border-slate-800 p-5">
              <ul className="space-y-2">
                {blueprint.riskAreas.map((r) => (
          ...
          {blueprint.workflowPreview.length > 0 && (
            <section>
              <h2 className="text-white font-semibold text-lg mb-4">Architecture Workflow Preview</h2>
