...
const DEFAULT_WIDGET_EMBED_SRC = 'https://chatbot.rapidmvp.io/chatbot/embed?rule=insolvency&model=openai/gpt-5-mini&bg=%23250411'
const DEFAULT_WIDGET_SCRIPT_SRC = 'https://chatbot.rapidmvp.io/chatbot-widget/usageflows-chatbot.js'
